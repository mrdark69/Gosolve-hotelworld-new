<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="PTS.aspx.cs" Inherits="_PTS" %>
...
<asp:Content ID="FooterScript" ContentPlaceHolderID="ContentFooter" runat="server">
    <script type="text/javascript">
        ...
        function getList(v) {
            ...
            var url = "<%= ResolveUrl("/admin/Post/ajax_webmethod_post.aspx/GetPostype") %>";
        ...
        function GenlistAll(data) {
           ...
           // var data = $.grep(raw_data, function (e) { return e.RefID == 0; }); 
            for (var i in data) {
                var PostTypeID = data[i].PostTypeID;
                ret += '<tr>';
                //ret += '   <td><input type="checkbox" checked class="i-checks" disabled name="input[]"></td>';
                ret += '   <td><strong><a href="PTSManage?PostTypeID=' + PostTypeID + '"><i class="fa fa-star"></i>' + data[i].Title + '</a></strong></td>';
